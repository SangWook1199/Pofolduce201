...
//		@PostMapping("/mypage/update")
//		public String updateUserInfomation(RedirectAttributes redirectAttributes, HttpServletRequest request, String nickname, String email){
//			// 세션에서 userId 가져오기
//		    HttpSession session = request.getSession(false);
//		    if (session == null || session.getAttribute("userId") == null) {
//		        // 로그인 안 된 상태면 로그인 페이지로
...
//		
//			if(!update) {
//		        redirectAttributes.addFlashAttribute("errorMessage", "이미 존재하는 닉네임 또는 이메일입니다.");
